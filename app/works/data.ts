...
export const projects: Project[] = [
  ...
  },
  {
    slug: "slack-reminder",
    title: "Slack自動リマインド",
    description: "社外チャンネルの3時間以内未返信を自動検知し、担当者にリマインド送信。業務効率化に大きく貢献。",
    shortDescription: "社外チャンネルの3時間以内未返信を自動検知し、担当者にリマインド送信。業務効率化に大きく貢献。",
    icon: "FaCode",
    color: "green",
    tags: ["Python", "Slack API", "自動化"],
    details: {
      overview: "社外とのコミュニケーションの質向上を目的とした、Slack自動リマインドシステムの開発プロジェクトです。重要な顧客対応の見落としを防ぎ、チーム全体の業務効率化を実現しました。",
      challenges: [
        "大量のSlackメッセージの効率的な監視",
        "社外・社内チャンネルの自動判別",
        "適切なタイミングでのリマインド配信",
        "システムの安定稼働と監視"
      ],
      ...
      technologies: ["Python", "Slack API", "SQLite", "cron", "Docker", "AWS Lambda"],
      duration: "3ヶ月",
      role: "フルスタックエンジニア・業務効率化"
    }
  },
  {
    slug: "portfolio-site",
